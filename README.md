...
Миграции базы данных выполняются автоматически через Liquibase при запуске приложения.БД будет заполнена тестовыми данными. <br/>
...
button <img width="218" height="61" alt="image" src="https://github.com/user-attachments/assets/7028fe3b-7f8e-4c37-95af-e7cad2f163d8" />).
Для основных операций используются Id карт и пользователей.
<br/>
  Для получения доступа к ADMIN ресурсам (запрос на аутентификацию) :
       {
